...
def parse_first_page(url):
    ...
    # print(len(ret))
    # 打开文件
    fp = open('隋唐演义.txt', 'w', encoding='utf8')
    # 遍历所有的a对象
    for oa in a_list:
        # 取出这个a的内容
        title = oa.string
...
def main():
    #url = 'http://www.shicimingju.com/book/sanguoyanyi.html' #三国演义
    #url = 'http://www.shicimingju.com/book/hongloumeng.html' #红楼梦
    #url = 'http://www.shicimingju.com/book/shiji.html' #史记
    url = 'http://www.shicimingju.com/book/suitangyanyi.html' #隋唐演义
    # 解析第一个页面，返回所有的章节列表
